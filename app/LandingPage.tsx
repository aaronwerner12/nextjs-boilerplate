    ...
    <div style={{ background: "#132E22", minHeight: "100vh", fontFamily: "'Inter', system-ui, sans-serif", color: "#F7F5EF", overflowX: "hidden" }}>
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .land-btn-secondary:hover { border-color: rgba(200,185,122,.4); color: #E0784E; }
        ...
        .land-stat-val {
          ...
          color: #E0784E; line-height: 1;
          margin-bottom: 6px;
        }
        .land-stat-label {
          font-size: 12px; color: #6C7065;
        ...
        .land-section-eyebrow {
          ...
          color: #E0784E; margin-bottom: 16px;
        }
        ...
        .land-section-sub {
          font-size: 17px; color: #9FB8A9; line-height: 1.7;
        ...
        .land-step-title {
          ...
          color: #F7F5EF; margin-bottom: 10px;
          line-height: 1.3;
        }

        .land-step-body {
          font-size: 14px; color: #6C7065; line-height: 1.7;
        }
        ...
        .land-feature:hover { border-color: rgba(200,185,122,.4); border-top-color: #E0784E; }
        ...
        .land-feature-title {
          ...
          color: #F7F5EF; margin-bottom: 8px;
        }

        .land-feature-body {
          font-size: 13.5px; color: #6C7065; line-height: 1.6;
        }
      ...
      <section className="land-cta-section">
        ...
        <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: "clamp(32px, 5vw, 56px)", fontWeight: 600, lineHeight: 1.15, marginBottom: 20, letterSpacing: "-.02em" }}>
          Your next ETF award<br />starts <em style={{ fontStyle: "italic", color: "#E0784E" }}>here.</em>
        </h2>
        <p style={{ fontSize: 17, color: "#9FB8A9", lineHeight: 1.7, maxWidth: 480, margin: "0 auto 40px" }}>
      ...
      <footer className="land-footer">
        ...
        <div style={{ display: "flex", gap: 20, alignItems: "center" }}>
          <a href="/terms" style={{ fontSize: 12.5, color: "#7E9C8D", textDecoration: "none" }}>Terms</a>
          <a href="/privacy" style={{ fontSize: 12.5, color: "#7E9C8D", textDecoration: "none" }}>Privacy</a>
          <a href="/?signin=1" style={{ fontSize: 12.5, color: "#6C7065", textDecoration: "none" }}>Sign In →</a>
        </div>
      </footer>
